...
import { getWifiPageState, getWifiStudentId, setWifiPageState } from '../../utils/storage'
...
function buildInitialData() {
  ...
  const fallbackMode = app.globalData.isAuthenticated ? 'authenticated' : 'standalone'
